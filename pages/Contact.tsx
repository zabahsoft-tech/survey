      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <div className="flex items-start space-x-4 space-x-reverse bg-slate-900 p-6 rounded-xl border border-slate-800 shadow-lg">
              ...
              <div className="w-full">
                ...
                <p className="text-gray-400 dir-ltr text-right">{settings.phone}</p>
                <div className="mt-4">
                  <a 
            ...
            <div className="flex items-start space-x-4 space-x-reverse bg-slate-900 p-6 rounded-xl border border-slate-800 shadow-lg">
              ...
              <div>
                ...
                <p className="text-gray-400 font-mono">{settings.email}</p>
              </div>
            </div>
          </div>

          <div className="bg-slate-800 rounded-2xl overflow-hidden h-full min-h-[400px] relative border border-slate-700 shadow-2xl">
            <img 
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="bg-slate-900/90 backdrop-blur px-6 py-4 rounded-xl shadow-lg flex flex-col items-center border border-slate-700">
                ...
                <span className="font-bold text-white">موقعیت: {settings.address.split('،')[0]}</span>
              </div>
            </div>
          </div>
        </div>
